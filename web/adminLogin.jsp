...
<div class="wrap">
    ...
    <div class="main">
        <div class="sidebarg fnone">
            <form id="form1" action="adminLogin" method="post" target='_blank'>
                <div class="login">
                    <dl>
                        <dt>管理员登陆</dt>

                        <dd><label for="name">用户名：</label><input type="text" class="inputh" value="" name="name" id="name"/></dd>
                        <dd><label for="password">密 码：</label><input type="text" class="inputh" value="" name="password" id="password"/></dd>
                        ...
                        <dd class="buttom">
                            <input id="login" type="button" value="登 录" class="spbg buttombg buttomb f14 lf" />
